...
namespace Dapplo.SignalR.Test.VueDemo.Configuration.Impl
{
    internal class WebserverConfiguration : IniSectionBase<IWebserverConfiguration>, IWebserverConfiguration
    {
